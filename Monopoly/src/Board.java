...
public class Board {
	...
	public void makeBoard(){
		...
		board.add(new Board("Jail", "None", 0, "N/A"));
		...
		board.add(new Board("Free Parking", "None", 0, "N/A"));
		...
		board.add(new Board("Go to Jail", "Change position", 0, "N/A"));
		...
		board.add(new Board("Luxary Tax", "Charge Money", -100, "N/A"));
